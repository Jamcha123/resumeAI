...
function AddResume(){
  ...
  return(
    <form action="" method="get" id="form" className="fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] w-[40em] h-[75%] m-auto p-[0] bg-transparent ">
      <div className="flex flex-col mt-[10%] align-middle justify-evenly text-center min-h-[10em] min-w-[100%] ">
...
export default function App(){
  return(
    <div className="w-[100%] h-[100%] m-auto p-[0] fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] ">
      <AddResume></AddResume>
    </div>
  )
}